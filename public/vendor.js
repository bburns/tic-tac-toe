...
require.register("assertion-error/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "assertion-error");
  (function() {
    'use strict';
...
require.register("chai/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "chai");
  (function() {
    'use strict';
...
require.register("chai/lib/chai/utils/expectTypes.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "chai");
  (function() {
    'use strict';
...
require.register("chai/lib/chai/utils/getPathInfo.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "chai");
  (function() {
    'use strict';
...
require.register("chai/lib/chai/utils/hasProperty.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "chai");
  (function() {
    'use strict';
...
_exports.test = require('./test');

/*!
 * type utility
 */

_exports.type = require('type-detect');

/*!
 * expectTypes utility
 */
_exports.expectTypes = require('./expectTypes');

/*!
 * message utility
 */

_exports.getMessage = require('./getMessage');

/*!
 * actual utility
 */

_exports.getActual = require('./getActual');

/*!
 * Inspect util
 */

_exports.inspect = require('./inspect');

/*!
 * Object Display util
 */

_exports.objDisplay = require('./objDisplay');

/*!
 * Flag utility
 */

_exports.flag = require('./flag');

/*!
 * Flag transferring utility
 */

_exports.transferFlags = require('./transferFlags');

/*!
 * Deep equal utility
 */

_exports.eql = require('deep-eql');

/*!
 * Deep path value
 */

_exports.getPathValue = require('./getPathValue');

/*!
 * Deep path info
 */

_exports.getPathInfo = require('./getPathInfo');

/*!
 * Check if a property exists
 */

_exports.hasProperty = require('./hasProperty');

/*!
 * Function name
 */

_exports.getName = require('./getName');

/*!
 * add Property
 */

_exports.addProperty = require('./addProperty');

/*!
 * add Method
 */

_exports.addMethod = require('./addMethod');

/*!
 * overwrite Property
 */

_exports.overwriteProperty = require('./overwriteProperty');

/*!
 * overwrite Method
 */

_exports.overwriteMethod = require('./overwriteMethod');

/*!
 * Add a chainable method
 */

_exports.addChainableMethod = require('./addChainableMethod');

/*!
 * Overwrite chainable method
 */

_exports.overwriteChainableMethod = require('./overwriteChainableMethod');
  })();
});
...
require.register("deep-eql/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "deep-eql");
  (function() {
    'use strict';
...
require.register("deep-eql/lib/eql.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "deep-eql");
  var _Buffer = require('buffer'); var Buffer = _Buffer && _Buffer.Buffer;
(function() {
    'use strict';
...
require.register("deep-eql/node_modules/type-detect/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "deep-eql/node_modules/type-detect");
  (function() {
    'use strict';
...
require.register("deep-eql/node_modules/type-detect/lib/type.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "deep-eql/node_modules/type-detect");
  (function() {
    'use strict';
...
require.register("element-class/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "element-class");
  (function() {
    'use strict';
...
require.register("lodash._baseassign/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "lodash._baseassign");
  (function() {
    'use strict';
...
require.register("lodash._basecopy/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "lodash._basecopy");
  (function() {
    "use strict";
...
require.register("lodash._bindcallback/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "lodash._bindcallback");
  (function() {
    'use strict';
...
require.register("lodash._createassigner/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "lodash._createassigner");
  (function() {
    'use strict';
...
require.register("lodash._getnative/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "lodash._getnative");
  (function() {
    'use strict';
...
require.register("lodash._isiterateecall/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "lodash._isiterateecall");
  (function() {
    'use strict';
...
require.register("lodash.assign/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "lodash.assign");
  (function() {
    'use strict';
...
require.register("lodash.keys/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "lodash.keys");
  (function() {
    'use strict';
...
require.register("lodash.restparam/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "lodash.restparam");
  (function() {
    'use strict';
...
var Modal = React.createClass({
  ...
  statics: {
    ...
    injectCSS: function injectCSS() {
      "production" !== 'development' && console.warn('React-Modal: injectCSS has been deprecated ' + 'and no longer has any effect. It will be removed in a later version');
    }
  },
...
require.register("type-detect/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "type-detect");
  (function() {
    'use strict';
...
require.register("type-detect/lib/type.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "type-detect");
  (function() {
    'use strict';
...
require.register("Users/bburns/Dropbox/docs/Projects/@freecodecamp/tictactoe/app/code/tic.js", function(exports, require, module) {
'use strict';
...
tic.playAgainstSelf = function () {
    ...
    while (gameState == tic.statePlay) {
        ...
        var moves = tic.getMoves(board);
        if (score !== 0 || moves == 0) gameState = tic.stateDone;
        player = -player;
    }
    tic.log(board);
};
...
require.register("test/test_tictactoe.js", function(exports, require, module) {
'use strict';
...
var boardEmpty = [[_, _, _], [_, _, _], [_, _, _]];

var boardXXX = [[X, O, X], [O, X, _], [_, O, X]];

var boardOOO = [[X, O, X], [O, X, X], [O, O, O]];

var boardOO = [[X, O, _], [O, O, _], [X, X, _]];

var boardXX = [[_, _, O], [_, X, X], [X, _, O]];
...
describe('tictactoe', function () {
    ...
    it('x should finish xx', function () {
        var board = [[O, _, O], [O, X, X], [_, X, 2]];
        tic.getMove(board, X, 4).should.eql([{ i: 0, j: 1 }, 1]);
    });

    // works
    it('x should finish xx', function () {
        var board = [[O, _, 2], [_, X, X], [O, 2, 2]];
